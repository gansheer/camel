...
public class AsteriskComponentTest extends CamelTestSupport {
    ...
    void testCreateComponent() throws Exception {
        ...
        assertNotNull(component.getCamelContext());
    }
    ...
    void testCreateEndpoint() throws Exception {
        ...
        AsteriskEndpoint endpoint = (AsteriskEndpoint) component.createEndpoint(
                "asterisk://myVoIP?hostname=localhost&username=admin&password=secret&action=QUEUE_STATUS");

        assertNotNull(endpoint);
        assertTrue(endpoint instanceof AsteriskEndpoint);
    }
}
