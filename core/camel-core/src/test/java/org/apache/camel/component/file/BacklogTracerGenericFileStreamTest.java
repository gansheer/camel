...
/**
 * CAMEL-24392: BacklogTracerRouteAdvice drains GenericFile InputStream body before stream caching kicks in, causing
 * empty body on SFTP/FTP streamDownload.
 */
class BacklogTracerGenericFileStreamTest extends ContextTestSupport {

    @Test
    void testWrappedFileStreamBodyNotDrained() throws Exception {
        ...
        file.setBody(nonResettableStream("Hello World"));
